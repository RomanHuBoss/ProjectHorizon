...
Текущий Stage 1 vertical slice и NPC/faction subsystem through TASK-123 закрыты принятой владельцем продукта приёмкой. Текущая mega-итерация TASK-124 реализует наземную NPC navigation subsystem PDF v2.0 §30.1: локальные tiled NavigationRegion3D, NavigationServer3D path queries, NavigationAgent3D avoidance, obstacle-aware streaming и stuck recovery без whole-planet navmesh.

### Подсистемы through TASK-123 — `VERIFIED`; ground NPC navigation / bounded nav streaming — `IMPLEMENTED`
...
F5             TASK-076 + TASK-110 + TASK-112 + TASK-114 + TASK-116 + TASK-118 + TASK-120 + TASK-122 + TASK-124 mega-acceptance
