...
Текущий Stage 1 vertical slice и подсистемы through TASK-121 закрыты принятой владельцем продукта приёмкой. Текущая mega-итерация TASK-122 закрывает базовое ядро NPC и фракций PDF v2.0 §16: три фракции, все восемь типов NPC, локализованные условные диалоги, per-faction reputation, физическую наземную популяцию, hostile/protected targets и delta-only persistence.

### Подсистемы through TASK-121 — `VERIFIED`; NPC / factions / dialogues / ground combat targets — `IMPLEMENTED`
...
F5             TASK-076 + TASK-110 + TASK-112 + TASK-114 + TASK-116 + TASK-118 + TASK-120 + TASK-122 mega-acceptance
