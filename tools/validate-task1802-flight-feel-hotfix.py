...
need(version in {"0.1.0-alpha.180.2", "0.1.0-alpha.180.3", "0.1.0-alpha.182", "0.1.0-alpha.184", "0.1.0-alpha.184.1", "0.1.0-alpha.186"}, "VERSION must be alpha.180.2 or later hotfix", f)
