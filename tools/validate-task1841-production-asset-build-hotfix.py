...
need(version in {'0.1.0-alpha.184.1', '0.1.0-alpha.186','0.1.0-alpha.188','0.1.0-alpha.192','0.1.0-alpha.192.1','0.1.0-alpha.194'}, 'VERSION must preserve alpha.184.1 hotfix or later accepted revision')
