...
if VERSION.read_text().strip() not in {'0.1.0-alpha.184', '0.1.0-alpha.184.1','0.1.0-alpha.186','0.1.0-alpha.188','0.1.0-alpha.190'}: fail('VERSION must be alpha.184/184.1/186')
