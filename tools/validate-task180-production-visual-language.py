...
need(version in {"0.1.0-alpha.180", "0.1.0-alpha.180.1", "0.1.0-alpha.180.2", "0.1.0-alpha.180.3", "0.1.0-alpha.182", "0.1.0-alpha.184"}, "VERSION must be alpha.180 or alpha.180.1", f)
for node in (
