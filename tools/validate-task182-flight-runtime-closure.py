...
need(version in {"0.1.0-alpha.182", "0.1.0-alpha.184", "0.1.0-alpha.184.1", "0.1.0-alpha.186", "0.1.0-alpha.188"}, "VERSION must be alpha.182 or later accepted revision", f)
